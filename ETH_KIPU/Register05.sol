...
contract Register05 {
    ...
    * logra que no se gaste gas al abortar la ejecucion
    * revierte y manda el error
    */
    function setInfo(string memory myInfo) external {
        require(msg.sender == owner, "Only owner"); //esto es rapido pero ojo limitar el mensaje
        storedInfo = myInfo;
    }
